...
private const val BOTTOM_INDICATOR_X_CIRCLE_OFFSET = 4f
    ...
    Canvas(
        ...
        for (i in minWeight..maxWeight) {
            ...
            val lineLength = when (lineType) {
                ...
                LineType.FIVE_STEP -> style.fiveStepLineLength.toPx()
                LineType.TEN_STEP -> style.tenStepLineLength.toPx()
            }
            val lineColor = when (lineType) {
                LineType.NORMAL -> style.normalLineColor
                LineType.FIVE_STEP -> style.fiveStepLineColor
                LineType.TEN_STEP -> style.tenStepLineColor
            }
            ...
            val bottomLeft = Offset(
                x = circleCenter.x - BOTTOM_INDICATOR_X_CIRCLE_OFFSET,
